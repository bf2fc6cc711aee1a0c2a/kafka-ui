    ...
    return {
        ...
        createTopic: async (newTopicInput: NewTopicInput, options: any = {}): Promise<RequestArgs> => {
            ...
            if (newTopicInput === null || newTopicInput === undefined) {
                throw new RequiredError('newTopicInput','Required parameter newTopicInput was null or undefined when calling createTopic.');
            }
         ...
         * @throws {RequiredError}
         */
        deleteGroup: async (groupName: string, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/groups/{groupName}`
         ...
         * @throws {RequiredError}
         */
        getGroup: async (groupName: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupName' is not null or undefined
            if (groupName === null || groupName === undefined) {
        ...
        getTopic: async (topicName: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'topicName' is not null or undefined
            if (topicName === null || topicName === undefined) {
                throw new RequiredError('topicName','Required parameter topicName was null or undefined when calling getTopic.');
            }
            const localVarPath = `/topics/{topicName}`
                .replace(`{${"topicName"}}`, encodeURIComponent(String(topicName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        updateTopic: async (topicName: string, topicSettings: TopicSettings, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'topicName' is not null or undefined
            if (topicName === null || topicName === undefined) {
                throw new RequiredError('topicName','Required parameter topicName was null or undefined when calling updateTopic.');
            }
            // verify required parameter 'topicSettings' is not null or undefined
            if (topicSettings === null || topicSettings === undefined) {
                throw new RequiredError('topicSettings','Required parameter topicSettings was null or undefined when calling updateTopic.');
            }
            const localVarPath = `/topics/{topicName}`
                .replace(`{${"topicName"}}`, encodeURIComponent(String(topicName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
        ...
        async createTopic(newTopicInput: NewTopicInput, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Topic>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).createTopic(newTopicInput, options);
         ...
         * @throws {RequiredError}
         */
        async deleteGroup(groupName: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).deleteGroup(groupName, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async deleteTopic(topicName: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).deleteTopic(topicName, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getGroup(groupName: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getGroup(groupName, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getGroupsList(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getGroupsList(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getTopic(topicName: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Topic>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getTopic(topicName, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getTopicsList(limit?: number, filter?: string, offset?: number, order?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TopicsList>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getTopicsList(limit, filter, offset, order, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async metrics(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).metrics(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async openApi(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).openApi(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateTopic(topicName: string, topicSettings: TopicSettings, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Topic>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).updateTopic(topicName, topicSettings, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        createTopic(newTopicInput: NewTopicInput, options?: any): AxiosPromise<Topic> {
            return DefaultApiFp(configuration).createTopic(newTopicInput, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} groupName Consumer group identificator
        ...
        deleteGroup(groupName: string, options?: any): AxiosPromise<void> {
            return DefaultApiFp(configuration).deleteGroup(groupName, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes the topic with the specified name.
         * @summary Deletes a  topic
        ...
        deleteTopic(topicName: string, options?: any): AxiosPromise<void> {
            return DefaultApiFp(configuration).deleteTopic(topicName, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} groupName Consumer group identificator
        ...
        getGroup(groupName: string, options?: any): AxiosPromise<void> {
            return DefaultApiFp(configuration).getGroup(groupName, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
        ...
        getGroupsList(options?: any): AxiosPromise<void> {
            return DefaultApiFp(configuration).getGroupsList(options).then((request) => request(axios, basePath));
        },
        /**
         * Topic
         * @summary Retrieves the topic with the specified name.
        ...
        getTopic(topicName: string, options?: any): AxiosPromise<Topic> {
            return DefaultApiFp(configuration).getTopic(topicName, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a list of all of the available topics, or the list of topics that meet the users URL Query Parameters.
         * @summary List of topics
        ...
        getTopicsList(limit?: number, filter?: string, offset?: number, order?: string, options?: any): AxiosPromise<TopicsList> {
            return DefaultApiFp(configuration).getTopicsList(limit, filter, offset, order, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Admin server metrics
        ...
        metrics(options?: any): AxiosPromise<void> {
            return DefaultApiFp(configuration).metrics(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
        ...
        openApi(options?: any): AxiosPromise<void> {
            return DefaultApiFp(configuration).openApi(options).then((request) => request(axios, basePath));
        },
        /**
         * updates the topic with the new data.
         * @summary Updates the topic with the specified name.
        ...
        updateTopic(topicName: string, topicSettings: TopicSettings, options?: any): AxiosPromise<Topic> {
            return DefaultApiFp(configuration).updateTopic(topicName, topicSettings, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class DefaultApi extends BaseAPI implements DefaultApiInterface {
    ...
    public deleteGroup(groupName: string, options?: any) {
        return DefaultApiFp(this.configuration).deleteGroup(groupName, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getGroup(groupName: string, options?: any) {
        return DefaultApiFp(this.configuration).getGroup(groupName, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getGroupsList(options?: any) {
        return DefaultApiFp(this.configuration).getGroupsList(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public openApi(options?: any) {
        return DefaultApiFp(this.configuration).openApi(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public updateTopic(topicName: string, topicSettings: TopicSettings, options?: any) {
        return DefaultApiFp(this.configuration).updateTopic(topicName, topicSettings, options).then((request) => request(this.axios, this.basePath));
    }
}
