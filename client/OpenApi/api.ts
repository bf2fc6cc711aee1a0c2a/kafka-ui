...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTopicsList: async (limit?: number, filter?: string, offset?: number, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/topics`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getTopicsList(limit?: number, filter?: string, offset?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TopicsList>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getTopicsList(limit, filter, offset, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTopicsList(limit?: number, filter?: string, offset?: number, options?: any): AxiosPromise<TopicsList> {
            return DefaultApiFp(configuration).getTopicsList(limit, filter, offset, options).then((request) => request(axios, basePath));
        },
        /**
         * updates the topic with the new data.
         * @summary Updates the topic with the specified name.
...
export class DefaultApi extends BaseAPI implements DefaultApiInterface {
     ...
     * @memberof DefaultApi
     */
    public getTopicsList(limit?: number, filter?: string, offset?: number, options?: any) {
        return DefaultApiFp(this.configuration).getTopicsList(limit, filter, offset, options).then((request) => request(this.axios, this.basePath));
    }
